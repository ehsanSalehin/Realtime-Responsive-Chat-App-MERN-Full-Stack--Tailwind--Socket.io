                ...
                {contact?.image ? (
                  ...
                  <div
                    className={`uppercase w-full h-full flex items-center justify-center rounded-full text-[#12527a] text-lg font-bold ${
                      selectedChatData && selectedChatData._id === contact._id ? "bg-[#ffffff2] border border-white/50" : getColor(contact.color)
                    }`}
                  >
