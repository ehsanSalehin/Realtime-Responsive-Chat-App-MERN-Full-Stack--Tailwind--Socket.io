...
export const SEARCH_COUNTACTS_ROUTES=`${CONTACTS_ROUTES}/search`;
export const GET_DIRECTMESSAGE_CONTACTS_ROUTE = `/${CONTACTS_ROUTES}/get-contacts-for-directmessages`;
